...
char* my_generator(const char* text, int state)
{
  ...
  vector<string> words {"addACL",
      ...
      "setWebHookQueueSize(",
      "setNumWebHookConnsPerThread(",
      "setWebHookTimeoutSecs(",
      "disableBuiltinBlacklists()",
      "blacklistPersistDB(",
      "blacklistPersistReplicated()",
      "blacklistPersistConnectTimeout(",
      "blacklistPersistRWTimeout(",
      "setBlacklistV4Prefix(",
      "setBlacklistV6Prefix(",
      "blacklistRedisUsername(",
      "blacklistRedisPassword(",
      "blacklistRedisTLS(",
      "blacklistRedisTLSCA(",
      "blacklistRedisTLSClientCert(",
      "blacklistRedisTLSVerifyPeer(",
      "blacklistRedisTLSServerName(",
      "blacklistNetmask(",
      "blacklistIP(",
      "blacklistLogin(",
      "blacklistIPLogin(",
      "blacklistIPPrefixLogin(",
      "blacklistJA3(",
      "blacklistIPJA3(",
      "blacklistIPPrefixJA3(",
      "unblacklistNetmask(",
      "unblacklistIP(",
      "unblacklistLogin(",
      "unblacklistIPLogin(",
      "unblacklistIPPrefixLogin(",
      "unblacklistJA3(",
      "unblacklistIPJA3(",
      "unblacklistIPPrefixJA3(",
      "checkBlacklistIP(",
      "checkBlacklistLogin(",
      "checkBlacklistIPLogin(",
      "checkBlacklistIPPrefixLogin(",
      "checkBlacklistJA3(",
      "checkBlacklistIPJA3(",
      "checkBlacklistIPPrefixJA3(",
      "getIPBlacklist()",
      "getLoginBlacklist()",
      "getIPLoginBlacklist()",
      "getJA3Blacklist()",
      ...
      "getBlacklistJA3RetMsg()",
      "getBlacklistIPJA3RetMsg()",
      "setBlacklistIPRetMsg(",
      "setBlacklistLoginRetMsg(",
      "setBlacklistIPLoginRetMsg(",
      "setBlacklistJA3RetMsg(",
      "setBlacklistIPJA3RetMsg(",
      "disableBuiltinWhitelists()",
      "whitelistPersistDB(",
      "whitelistPersistReplicated()",
      "whitelistPersistConnectTimeout(",
      "whitelistPersistRWTimeout(",
      "setWhitelistV4Prefix(",
      "setWhitelistV6Prefix(",
      "whitelistRedisUsername(",
      "whitelistRedisPassword(",
      "whitelistRedisTLS(",
      "whitelistRedisTLSCA(",
      "whitelistRedisTLSClientCert(",
      "whitelistRedisTLSVerifyPeer(",
      "whitelistRedisTLSServerName(",
      "whitelistNetmask(",
      "whitelistIP(",
      "whitelistLogin(",
      "whitelistIPLogin(",
      "whitelistIPPrefixLogin(",
      "whitelistJA3(",
      "whitelistIPJA3(",
      "whitelistIPPrefixJA3(",
      "unwhitelistNetmask(",
      "unwhitelistIP(",
      "unwhitelistLogin(",
      "unwhitelistIPLogin(",
      "unwhitelistIPPrefixLogin(",
      "unwhitelistJA3(",
      "unwhitelistIPJA3(",
      "unwhitelistIPPrefixJA3(",
      "checkWhitelistIP(",
      "checkWhitelistLogin(",
      "checkWhitelistIPLogin(",
      "checkWhitelistIPPrefixLogin(",
      "checkWhitelistJA3(",
      "checkWhitelistIPJA3(",
      "checkWhitelistIPPrefixJA3(",
      "getIPWhitelist()",
      "getLoginWhitelist()",
      "getIPLoginWhitelist()",
      "getJA3Whitelist()",
      ...
      "setMinSyncHostUptime(",
      "setNumSiblingThreads(",
      "setCustomEndpoint(",
